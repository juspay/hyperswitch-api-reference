...
<Info>Click [**here**](https://api-reference.hyperswitch.io/docs/hyperswitch-api-reference/febe7408d8cf6-outgoing-webhook) to see the webhook payload your endpoint would need to parse for each of the above events</Info>
