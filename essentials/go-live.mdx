...
- [ ] [Configure your webhook endpoint](https://api-reference.hyperswitch.io/docs/hyperswitch-api-reference/5cc9374300b99-webhooks#configuring-webhooks) on our dashboard to receive notifications for different events.
- [ ] Update Hyperswitch's webhook endpoints on your connector's Dashboard. [Refer here](https://api-reference.hyperswitch.io/docs/hyperswitch-api-reference/5cc9374300b99-webhooks#configuring-webhooks) for detailed instructions.
...
- [ ] Make sure your API integration is set up to handle all the possible error scenarios (refer this [link](https://api-reference.hyperswitch.io/docs/hyperswitch-api-reference/rj310cmeho0f5-error-codes)).
