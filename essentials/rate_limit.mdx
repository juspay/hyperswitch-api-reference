...
The default rate limit for all Hyperswitch APIs is **80 requests per second**. Reach out to our [support team](biz@hyperswitch.io) if you have a requirement for higher limits.
</div>
